...
public class EmployeRESTController {
	...
	@RequestMapping(value="/empsentreprise/{idEntreprise}",method = RequestMethod.GET)
	public List<Employe> getEmployesByEntrepriseId(@PathVariable("idEntreprise") Long idEntreprise) {
